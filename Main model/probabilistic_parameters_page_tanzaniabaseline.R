...
#District Hospital Level Critical Care transition probabilities
...
#Impact of EECC on Dsitrict Hospital Critical Care which takes into account EECC effectiveness
...
#Impact of ACC on District Hospital Critical Care which takes into account ACC effectiveness
...
#Cost of District Hospital Critical Care in each state
