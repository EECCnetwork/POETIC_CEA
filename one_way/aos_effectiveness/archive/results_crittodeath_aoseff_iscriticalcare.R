...
source("Markov_Model/probabilistic_analysis/Results/one_way/aos_effectiveness/pars_crittodeath_iscriticalcare_aos_eff.R")
...
isaric_oneway <- one_way_sense(outcome_dat = isaric_DALY_dat, 
                                 ...
                                 parameter = eff_aos_critical_to_death)
