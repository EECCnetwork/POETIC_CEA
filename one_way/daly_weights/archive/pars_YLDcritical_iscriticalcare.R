...
YLD_critical <- c(rep(0.6,nyear),rep(0.61,nyear),rep(0.62,nyear),
                rep(0.63,nyear),rep(0.64,nyear),rep(0.65,nyear),rep(0.66,nyear),
                rep(0.67,nyear),
                rep(0.68,nyear),rep(0.69,nyear),rep(0.70,nyear),rep(0.71,nyear),
                rep(0.72,nyear),rep(0.73,nyear))

sens_n <- length(YLD_critical)
