...
YLD_severe <- c(rep(0.08,nyear),rep(0.09,nyear),rep(0.10,nyear),
                rep(0.11,nyear),rep(0.12,nyear),rep(0.13,nyear),rep(0.14,nyear),rep(0.15,nyear),
                rep(0.16,nyear),rep(0.17,nyear),rep(0.18,nyear),rep(0.19,nyear))

sens_n <- length(YLD_severe)
