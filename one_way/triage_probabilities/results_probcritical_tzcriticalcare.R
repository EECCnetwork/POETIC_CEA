...
source("Markov_Model/probabilistic_analysis/Results/one_way/triage_probabilities/pars_probcritical_tzcriticalcare.R")
...
tanzania_oneway_dat <- rbind(tanzania_EECC_NHB,tanzania_EECCAOS_NHB)



triage_plot_critical <-ggplot(tanzania_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) + 
  ...
  scale_x_continuous(limits = c(0.03, 0.25), breaks = c(seq(0.03, 0.25, by = 0.01))) +
