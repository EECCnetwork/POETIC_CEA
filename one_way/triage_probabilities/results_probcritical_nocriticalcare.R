...
source("Markov_Model/probabilistic_analysis/Results/one_way/triage_probabilities/pars_probcritical_nocriticalcare.R")
...
nothing_oneway_dat <- rbind(nothing_EECC_NHB,nothing_EECCAOS_NHB)



triage_plot_critical <-ggplot(nothing_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) + 
  ...
  scale_x_continuous(limits = c(0.03, 0.25), breaks = c(seq(0.03, 0.25, by = 0.02))) +
