...
nyear <- 1000
triage_critical <- c(rep(0.04,nyear),rep(0.05,nyear),rep(0.06,nyear),rep(0.07,nyear),
                   rep(0.08,nyear),rep(0.09,nyear),rep(0.1,nyear),rep(0.11,nyear),
                   rep(0.12,nyear),rep(0.13,nyear),rep(0.14,nyear),rep(0.15,nyear),
                   rep(0.16,nyear),rep(0.17,nyear),rep(0.18,nyear),rep(0.19,nyear),
                   rep(0.20,nyear),rep(0.21,nyear),rep(0.22,nyear),rep(0.23,nyear),
                   rep(0.24,nyear),rep(0.25,nyear))

triage_severe <- 1 - triage_critical
...
eeccaos_critical_costs <- rtri(n = sens_n, mod = 1642.78, min = 561.18, max = 2125.06)
