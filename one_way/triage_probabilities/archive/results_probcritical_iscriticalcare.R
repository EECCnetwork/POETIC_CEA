...
source("Markov_Model/probabilistic_analysis/Results/one_way/triage_probabilities/pars_probcritical_iscriticalcare.R")
...
isaric_oneway_dat <- rbind(isaric_EECC_NHB,isaric_EECCAOS_NHB)



triage_plot_critical <-ggplot(isaric_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) + 
