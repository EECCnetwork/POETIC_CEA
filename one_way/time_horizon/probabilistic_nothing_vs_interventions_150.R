...
nothing_oneway_150 <- one_way_sense(outcome_dat = nothing_DALY_dat, 
                                cost_dat = nothing_costdat, 
                                parameter = timehorizon)
nothing_eecc_oneway_150 <- one_way_sense(outcome_dat = no_eecc_DALY_dat, 
                                     cost_dat = no_eecc_costdat, 
                                     parameter = timehorizon)
nothing_eeccaos_oneway_150 <- one_way_sense(outcome_dat = no_eeccaos_DALY_dat, 
                                        cost_dat = no_eeccaos_costdat, 
                                        parameter = timehorizon)


nothing_EECC_NHB_150 <- one_way_nhb(parameter = nothing_oneway_150$params,
                                intervention_mean_daly = nothing_oneway_150$meanDALYs, 
                                intervention_mean_cost = nothing_oneway_150$meanTotal_Cost,
                                intervention_min_daly = nothing_oneway_150$minDALYs, 
                                intervention_min_cost = nothing_oneway_150$minTotal_Cost,
                                intervention_max_daly = nothing_oneway_150$maxDALYs, 
                                intervention_max_cost = nothing_oneway_150$maxTotal_Cost,
                                comparator_mean_daly = nothing_eecc_oneway_150$meanDALYs, 
                                comparator_mean_cost = nothing_eecc_oneway_150$meanTotal_Cost,
                                comparator_min_daly = nothing_eecc_oneway_150$minDALYs, 
                                comparator_min_cost = nothing_eecc_oneway_150$minTotal_Cost,
                                comparator_max_daly = nothing_eecc_oneway_150$maxDALYs, 
                                comparator_max_cost = nothing_eecc_oneway_150$maxTotal_Cost,
                                wtp = 101,
                                intname = "Only EECC",
                                compname = "No Critical Care")

nothing_EECCAOS_NHB_150 <- one_way_nhb(parameter = nothing_oneway_150$params,
                                   intervention_mean_daly = nothing_oneway_150$meanDALYs, 
                                   intervention_mean_cost = nothing_oneway_150$meanTotal_Cost,
                                   intervention_min_daly = nothing_oneway_150$minDALYs, 
                                   intervention_min_cost = nothing_oneway_150$minTotal_Cost,
                                   intervention_max_daly = nothing_oneway_150$maxDALYs, 
                                   intervention_max_cost = nothing_oneway_150$maxTotal_Cost,
                                   comparator_mean_daly = nothing_eeccaos_oneway_150$meanDALYs, 
                                   comparator_mean_cost = nothing_eeccaos_oneway_150$meanTotal_Cost,
                                   comparator_min_daly = nothing_eeccaos_oneway_150$minDALYs, 
                                   comparator_min_cost = nothing_eeccaos_oneway_150$minTotal_Cost,
                                   comparator_max_daly = nothing_eeccaos_oneway_150$maxDALYs, 
                                   comparator_max_cost = nothing_eeccaos_oneway_150$maxTotal_Cost,
                                   wtp = 101,
                                   intname = "EECC & AOS",
                                   compname = "No Critical Care")

no_oneway_150_dat <- rbind(nothing_EECC_NHB_150,nothing_EECCAOS_NHB_150)