...
isaric_oneway_120 <- one_way_sense(outcome_dat = isaric_DALY_dat, 
                               cost_dat = isaric_costdat, 
                               parameter = timehorizon)
isaric_eecc_oneway_120 <- one_way_sense(outcome_dat = is_eecc_DALY_dat, 
                                    cost_dat = is_eecc_costdat, 
                                    parameter = timehorizon)
isaric_eeccaos_oneway_120 <- one_way_sense(outcome_dat = is_eeccaos_DALY_dat, 
                                       cost_dat = is_eeccaos_costdat, 
                                       parameter = timehorizon)


isaric_EECC_NHB_120 <- one_way_nhb(parameter = isaric_oneway_120$params,
                               intervention_mean_daly = isaric_oneway_120$meanDALYs, 
                               intervention_mean_cost = isaric_oneway_120$meanTotal_Cost,
                               intervention_min_daly = isaric_oneway_120$minDALYs, 
                               intervention_min_cost = isaric_oneway_120$minTotal_Cost,
                               intervention_max_daly = isaric_oneway_120$maxDALYs, 
                               intervention_max_cost = isaric_oneway_120$maxTotal_Cost,
                               comparator_mean_daly = isaric_eecc_oneway_120$meanDALYs, 
                               comparator_mean_cost = isaric_eecc_oneway_120$meanTotal_Cost,
                               comparator_min_daly = isaric_eecc_oneway_120$minDALYs, 
                               comparator_min_cost = isaric_eecc_oneway_120$minTotal_Cost,
                               comparator_max_daly = isaric_eecc_oneway_120$maxDALYs, 
                               comparator_max_cost = isaric_eecc_oneway_120$maxTotal_Cost,
                               wtp = 101,
                               intname = "Only EECC",
                               compname = "Regional or Referral Critical Care")

isaric_EECCAOS_NHB_120 <- one_way_nhb(parameter = isaric_oneway_120$params,
                                  intervention_mean_daly = isaric_oneway_120$meanDALYs, 
                                  intervention_mean_cost = isaric_oneway_120$meanTotal_Cost,
                                  intervention_min_daly = isaric_oneway_120$minDALYs, 
                                  intervention_min_cost = isaric_oneway_120$minTotal_Cost,
                                  intervention_max_daly = isaric_oneway_120$maxDALYs, 
                                  intervention_max_cost = isaric_oneway_120$maxTotal_Cost,
                                  comparator_mean_daly = isaric_eeccaos_oneway_120$meanDALYs, 
                                  comparator_mean_cost = isaric_eeccaos_oneway_120$meanTotal_Cost,
                                  comparator_min_daly = isaric_eeccaos_oneway_120$minDALYs, 
                                  comparator_min_cost = isaric_eeccaos_oneway_120$minTotal_Cost,
                                  comparator_max_daly = isaric_eeccaos_oneway_120$maxDALYs, 
                                  comparator_max_cost = isaric_eeccaos_oneway_120$maxTotal_Cost,
                                  wtp = 101,
                                  intname = "EECC & AOS",
                                  compname = "Regional or Referral Critical Care")

is_oneway_120_dat <- rbind(isaric_EECC_NHB_120,isaric_EECCAOS_NHB_120)
