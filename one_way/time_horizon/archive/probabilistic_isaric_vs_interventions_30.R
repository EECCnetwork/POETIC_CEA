...
isaric_oneway_30 <- one_way_sense(outcome_dat = isaric_DALY_dat, 
                               cost_dat = isaric_costdat, 
                               parameter = timehorizon)
isaric_eecc_oneway_30 <- one_way_sense(outcome_dat = is_eecc_DALY_dat, 
                                    cost_dat = is_eecc_costdat, 
                                    parameter = timehorizon)
isaric_eeccaos_oneway_30 <- one_way_sense(outcome_dat = is_eeccaos_DALY_dat, 
                                       cost_dat = is_eeccaos_costdat, 
                                       parameter = timehorizon)


isaric_EECC_NHB_30 <- one_way_nhb(parameter = isaric_oneway_30$params,
                               intervention_mean_daly = isaric_oneway_30$meanDALYs, 
                               intervention_mean_cost = isaric_oneway_30$meanTotal_Cost,
                               intervention_min_daly = isaric_oneway_30$minDALYs, 
                               intervention_min_cost = isaric_oneway_30$minTotal_Cost,
                               intervention_max_daly = isaric_oneway_30$maxDALYs, 
                               intervention_max_cost = isaric_oneway_30$maxTotal_Cost,
                               comparator_mean_daly = isaric_eecc_oneway_30$meanDALYs, 
                               comparator_mean_cost = isaric_eecc_oneway_30$meanTotal_Cost,
                               comparator_min_daly = isaric_eecc_oneway_30$minDALYs, 
                               comparator_min_cost = isaric_eecc_oneway_30$minTotal_Cost,
                               comparator_max_daly = isaric_eecc_oneway_30$maxDALYs, 
                               comparator_max_cost = isaric_eecc_oneway_30$maxTotal_Cost,
                               wtp = 101,
                               intname = "Only EECC",
                               compname = "Regional or Referral Critical Care")

isaric_EECCAOS_NHB_30 <- one_way_nhb(parameter = isaric_oneway_30$params,
                                  intervention_mean_daly = isaric_oneway_30$meanDALYs, 
                                  intervention_mean_cost = isaric_oneway_30$meanTotal_Cost,
                                  intervention_min_daly = isaric_oneway_30$minDALYs, 
                                  intervention_min_cost = isaric_oneway_30$minTotal_Cost,
                                  intervention_max_daly = isaric_oneway_30$maxDALYs, 
                                  intervention_max_cost = isaric_oneway_30$maxTotal_Cost,
                                  comparator_mean_daly = isaric_eeccaos_oneway_30$meanDALYs, 
                                  comparator_mean_cost = isaric_eeccaos_oneway_30$meanTotal_Cost,
                                  comparator_min_daly = isaric_eeccaos_oneway_30$minDALYs, 
                                  comparator_min_cost = isaric_eeccaos_oneway_30$minTotal_Cost,
                                  comparator_max_daly = isaric_eeccaos_oneway_30$maxDALYs, 
                                  comparator_max_cost = isaric_eeccaos_oneway_30$maxTotal_Cost,
                                  wtp = 101,
                                  intname = "EECC & AOS",
                                  compname = "Regional or Referral Critical Care")

is_oneway_30_dat <- rbind(isaric_EECC_NHB_30,isaric_EECCAOS_NHB_30)
