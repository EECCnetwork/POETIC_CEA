...
nothing_oneway_60 <- one_way_sense(outcome_dat = nothing_DALY_dat, 
                                cost_dat = nothing_costdat, 
                                parameter = timehorizon)
nothing_eecc_oneway_60 <- one_way_sense(outcome_dat = no_eecc_DALY_dat, 
                                     cost_dat = no_eecc_costdat, 
                                     parameter = timehorizon)
nothing_eeccaos_oneway_60 <- one_way_sense(outcome_dat = no_eeccaos_DALY_dat, 
                                        cost_dat = no_eeccaos_costdat, 
                                        parameter = timehorizon)


nothing_EECC_NHB_60 <- one_way_nhb(parameter = nothing_oneway_60$params,
                                intervention_mean_daly = nothing_oneway_60$meanDALYs, 
                                intervention_mean_cost = nothing_oneway_60$meanTotal_Cost,
                                intervention_min_daly = nothing_oneway_60$minDALYs, 
                                intervention_min_cost = nothing_oneway_60$minTotal_Cost,
                                intervention_max_daly = nothing_oneway_60$maxDALYs, 
                                intervention_max_cost = nothing_oneway_60$maxTotal_Cost,
                                comparator_mean_daly = nothing_eecc_oneway_60$meanDALYs, 
                                comparator_mean_cost = nothing_eecc_oneway_60$meanTotal_Cost,
                                comparator_min_daly = nothing_eecc_oneway_60$minDALYs, 
                                comparator_min_cost = nothing_eecc_oneway_60$minTotal_Cost,
                                comparator_max_daly = nothing_eecc_oneway_60$maxDALYs, 
                                comparator_max_cost = nothing_eecc_oneway_60$maxTotal_Cost,
                                wtp = 101,
                                intname = "Only EECC",
                                compname = "No Critical Care")

nothing_EECCAOS_NHB_60 <- one_way_nhb(parameter = nothing_oneway_60$params,
                                   intervention_mean_daly = nothing_oneway_60$meanDALYs, 
                                   intervention_mean_cost = nothing_oneway_60$meanTotal_Cost,
                                   intervention_min_daly = nothing_oneway_60$minDALYs, 
                                   intervention_min_cost = nothing_oneway_60$minTotal_Cost,
                                   intervention_max_daly = nothing_oneway_60$maxDALYs, 
                                   intervention_max_cost = nothing_oneway_60$maxTotal_Cost,
                                   comparator_mean_daly = nothing_eeccaos_oneway_60$meanDALYs, 
                                   comparator_mean_cost = nothing_eeccaos_oneway_60$meanTotal_Cost,
                                   comparator_min_daly = nothing_eeccaos_oneway_60$minDALYs, 
                                   comparator_min_cost = nothing_eeccaos_oneway_60$minTotal_Cost,
                                   comparator_max_daly = nothing_eeccaos_oneway_60$maxDALYs, 
                                   comparator_max_cost = nothing_eeccaos_oneway_60$maxTotal_Cost,
                                   wtp = 101,
                                   intname = "EECC & AOS",
                                   compname = "No Critical Care")

no_oneway_60_dat <- rbind(nothing_EECC_NHB_60,nothing_EECCAOS_NHB_60)