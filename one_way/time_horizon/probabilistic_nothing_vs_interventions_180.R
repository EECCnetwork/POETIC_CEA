...
nothing_oneway_180 <- one_way_sense(outcome_dat = nothing_DALY_dat, 
                                cost_dat = nothing_costdat, 
                                parameter = timehorizon)
nothing_eecc_oneway_180 <- one_way_sense(outcome_dat = no_eecc_DALY_dat, 
                                     cost_dat = no_eecc_costdat, 
                                     parameter = timehorizon)
nothing_eeccaos_oneway_180 <- one_way_sense(outcome_dat = no_eeccaos_DALY_dat, 
                                        cost_dat = no_eeccaos_costdat, 
                                        parameter = timehorizon)


nothing_EECC_NHB_180 <- one_way_nhb(parameter = nothing_oneway_180$params,
                                intervention_mean_daly = nothing_oneway_180$meanDALYs, 
                                intervention_mean_cost = nothing_oneway_180$meanTotal_Cost,
                                intervention_min_daly = nothing_oneway_180$minDALYs, 
                                intervention_min_cost = nothing_oneway_180$minTotal_Cost,
                                intervention_max_daly = nothing_oneway_180$maxDALYs, 
                                intervention_max_cost = nothing_oneway_180$maxTotal_Cost,
                                comparator_mean_daly = nothing_eecc_oneway_180$meanDALYs, 
                                comparator_mean_cost = nothing_eecc_oneway_180$meanTotal_Cost,
                                comparator_min_daly = nothing_eecc_oneway_180$minDALYs, 
                                comparator_min_cost = nothing_eecc_oneway_180$minTotal_Cost,
                                comparator_max_daly = nothing_eecc_oneway_180$maxDALYs, 
                                comparator_max_cost = nothing_eecc_oneway_180$maxTotal_Cost,
                                wtp = 101,
                                intname = "Only EECC",
                                compname = "No Critical Care")

nothing_EECCAOS_NHB_180 <- one_way_nhb(parameter = nothing_oneway_180$params,
                                   intervention_mean_daly = nothing_oneway_180$meanDALYs, 
                                   intervention_mean_cost = nothing_oneway_180$meanTotal_Cost,
                                   intervention_min_daly = nothing_oneway_180$minDALYs, 
                                   intervention_min_cost = nothing_oneway_180$minTotal_Cost,
                                   intervention_max_daly = nothing_oneway_180$maxDALYs, 
                                   intervention_max_cost = nothing_oneway_180$maxTotal_Cost,
                                   comparator_mean_daly = nothing_eeccaos_oneway_180$meanDALYs, 
                                   comparator_mean_cost = nothing_eeccaos_oneway_180$meanTotal_Cost,
                                   comparator_min_daly = nothing_eeccaos_oneway_180$minDALYs, 
                                   comparator_min_cost = nothing_eeccaos_oneway_180$minTotal_Cost,
                                   comparator_max_daly = nothing_eeccaos_oneway_180$maxDALYs, 
                                   comparator_max_cost = nothing_eeccaos_oneway_180$maxTotal_Cost,
                                   wtp = 101,
                                   intname = "EECC & AOS",
                                   compname = "No Critical Care")

no_oneway_180_dat <- rbind(nothing_EECC_NHB_180,nothing_EECCAOS_NHB_180)