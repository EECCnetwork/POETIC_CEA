...
tanzania_oneway_90 <- one_way_sense(outcome_dat = tanzania_DALY_dat, 
                                    cost_dat = tanzania_costdat, 
                                    parameter = timehorizon)
tanzania_eecc_oneway_90 <- one_way_sense(outcome_dat = tz_eecc_DALY_dat, 
                                         cost_dat = tz_eecc_costdat, 
                                         parameter = timehorizon)
tanzania_eeccaos_oneway_90 <- one_way_sense(outcome_dat = tz_eeccaos_DALY_dat, 
                                            cost_dat = tz_eeccaos_costdat, 
                                            parameter = timehorizon)



tanzania_EECC_NHB_90 <- one_way_nhb(parameter = tanzania_oneway_90$params,
                                 intervention_mean_daly = tanzania_oneway_90$meanDALYs, 
                                 intervention_mean_cost = tanzania_oneway_90$meanTotal_Cost,
                                 intervention_min_daly = tanzania_oneway_90$minDALYs, 
                                 intervention_min_cost = tanzania_oneway_90$minTotal_Cost,
                                 intervention_max_daly = tanzania_oneway_90$maxDALYs, 
                                 intervention_max_cost = tanzania_oneway_90$maxTotal_Cost,
                                 comparator_mean_daly = tanzania_eecc_oneway_90$meanDALYs, 
                                 comparator_mean_cost = tanzania_eecc_oneway_90$meanTotal_Cost,
                                 comparator_min_daly = tanzania_eecc_oneway_90$minDALYs, 
                                 comparator_min_cost = tanzania_eecc_oneway_90$minTotal_Cost,
                                 comparator_max_daly = tanzania_eecc_oneway_90$maxDALYs, 
                                 comparator_max_cost = tanzania_eecc_oneway_90$maxTotal_Cost,
                                 wtp = 101,
                                 intname = "Only EECC",
                                 compname = "District Level Critical Care")

tanzania_EECCAOS_NHB_90 <- one_way_nhb(parameter = tanzania_oneway_90$params,
                                    intervention_mean_daly = tanzania_oneway_90$meanDALYs, 
                                    intervention_mean_cost = tanzania_oneway_90$meanTotal_Cost,
                                    intervention_min_daly = tanzania_oneway_90$minDALYs, 
                                    intervention_min_cost = tanzania_oneway_90$minTotal_Cost,
                                    intervention_max_daly = tanzania_oneway_90$maxDALYs, 
                                    intervention_max_cost = tanzania_oneway_90$maxTotal_Cost,
                                    comparator_mean_daly = tanzania_eeccaos_oneway_90$meanDALYs, 
                                    comparator_mean_cost = tanzania_eeccaos_oneway_90$meanTotal_Cost,
                                    comparator_min_daly = tanzania_eeccaos_oneway_90$minDALYs, 
                                    comparator_min_cost = tanzania_eeccaos_oneway_90$minTotal_Cost,
                                    comparator_max_daly = tanzania_eeccaos_oneway_90$maxDALYs, 
                                    comparator_max_cost = tanzania_eeccaos_oneway_90$maxTotal_Cost,
                                    wtp = 101,
                                    intname = "EECC & AOS",
                                    compname = "District Level Critical Care")

tz_oneway_90_dat <- rbind(tanzania_EECC_NHB_90,tanzania_EECCAOS_NHB_90)