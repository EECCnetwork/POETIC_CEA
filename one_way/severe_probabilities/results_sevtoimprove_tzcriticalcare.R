...
source("Markov_Model/probabilistic_analysis/Results/one_way/severe_probabilities/pars_sevtoimprove_tzcriticalcare.R")
...
tanzania_oneway <- one_way_sense(outcome_dat = tanzania_DALY_dat, 
                                 ...
                                 parameter = tanzania_severe_to_discharge)
