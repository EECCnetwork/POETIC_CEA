...
source("Markov_Model/probabilistic_analysis/Results/one_way/severe_probabilities/results_sevtoimprove_nocriticalcare.R")

#load data for tz critical care

source("Markov_Model/probabilistic_analysis/Results/one_way/severe_probabilities/results_sevtoimprove_tzcriticalcare.R")


#load data for tz critical care

#source("Markov_Model/probabilistic_analysis/Results/one_way/severe_probabilities/results_sevtoimprove_iscriticalcare.R")

#rbind all three dataframes

final_dat <- rbind(no_oneway_dat, tz_oneway_dat)

plot_severetoimprove <-ggplot(final_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
