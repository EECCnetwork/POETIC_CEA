...
source("Markov_Model/probabilistic_analysis/Results/one_way/severe_probabilities/pars_sevtoimprove_iscriticalcare.R")
...
isaric_oneway <- one_way_sense(outcome_dat = isaric_DALY_dat, 
                                 ...
                                 parameter = isaric_severe_to_discharge)
