...
isaric_severe_to_discharge <- c(rep(0.02,nyear),rep(0.03,nyear),
                                rep(0.04,nyear),rep(0.05,nyear),
                                rep(0.06,nyear),rep(0.07,nyear))


sens_n <- length(isaric_severe_to_discharge)
