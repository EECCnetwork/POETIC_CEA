...
source("Markov_Model/probabilistic_analysis/Results/one_way/severe_probabilities/pars_sevtoimprove_nocriticalcare.R")
...
nothing_oneway <- one_way_sense(outcome_dat = nothing_DALY_dat, 
                                 ...
                                 parameter = nothing_severe_to_discharge)
