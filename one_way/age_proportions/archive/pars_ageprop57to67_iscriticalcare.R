...
age_strt_mort3_57to67 <- c(rep(0.18,nyear),rep(0.20,nyear),rep(0.22,nyear),
                           rep(0.24,nyear),rep(0.26,nyear),rep(0.28,nyear),rep(0.30,nyear),rep(0.32,nyear),
                           rep(0.34,nyear),rep(0.36,nyear),rep(0.38,nyear))

sens_n <- length(age_strt_mort3_57to67)
...
age_strt_mort4_68to100 <- rtri(n = sens_n, mod = 0.192, min = 0.092, max = 0.292)
age_threshold1 <- 18
age_threshold2 <- 46
age_threshold3 <- 57
age_threshold4 <- 68
