...
age_strt_mort4_68to100 <- c(rep(0.21,nyear),rep(0.23,nyear),rep(0.25,nyear),
                           rep(0.27,nyear),rep(0.29,nyear),rep(0.31,nyear),rep(0.33,nyear),rep(0.35,nyear),
                           rep(0.37,nyear),rep(0.39,nyear),rep(0.41,nyear))

sens_n <- length(age_strt_mort4_68to100)
