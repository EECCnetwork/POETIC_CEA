...
source("Markov_Model/probabilistic_analysis/Results/one_way/age_proportions/pars_ageprop18to45_tzcriticalcare.R")
...
tanzania_oneway <- one_way_sense(outcome_dat = tanzania_DALY_dat, 
                                 ...
                                 parameter = age_strt_mort1_18to45)
...
new_tanzania_EECC_NHB <- one_way_new(parameter = tanzania_oneway$params,
                                    intervention_daly = tz_eecc_DALY_dat, 
                                    intervention_cost = tz_eecc_costdat$totalcost,
                                    comparator_daly = tanzania_DALY_dat, 
                                    comparator_cost = tanzania_costdat$totalcost,
                                    wtp = 101,
                                    intervention_name = "EECC",
                                    comparator_name = "No Critical Care")

new_tanzania_EECCAOS_NHB <- one_way_new(parameter = tanzania_oneway$params,
                                       intervention_daly = tz_eeccaos_DALY_dat, 
                                       intervention_cost = tz_eeccaos_costdat$totalcost,
                                       comparator_daly = tanzania_DALY_dat, 
                                       comparator_cost = tanzania_costdat$totalcost,
                                       wtp = 101,
                                       intervention_name = "EECC & AOS",
                                       comparator_name = "No Critical Care")

new_tz_oneway_dat <- rbind(new_tanzania_EECC_NHB,new_tanzania_EECCAOS_NHB)
