...
source("Markov_Model/probabilistic_analysis/Results/one_way/age_proportions/pars_ageprop57to67_nocriticalcare.R")
...
nothing_oneway <- one_way_sense(outcome_dat = nothing_DALY_dat, 
                                 ...
                                 parameter = age_strt_mort3_57to67)
...
new_nothing_EECC_NHB <- one_way_new(parameter = nothing_oneway$params,
                                    intervention_daly = no_eecc_DALY_dat, 
                                    intervention_cost = no_eecc_costdat$totalcost,
                                    comparator_daly = nothing_DALY_dat, 
                                    comparator_cost = nothing_costdat$totalcost,
                                    wtp = 101,
                                    intervention_name = "EECC",
                                    comparator_name = "No Critical Care")

new_nothing_EECCAOS_NHB <- one_way_new(parameter = nothing_oneway$params,
                                       intervention_daly = no_eeccaos_DALY_dat, 
                                       intervention_cost = no_eeccaos_costdat$totalcost,
                                       comparator_daly = nothing_DALY_dat, 
                                       comparator_cost = nothing_costdat$totalcost,
                                       wtp = 101,
...
new_no_oneway_dat <- rbind(new_nothing_EECC_NHB,new_nothing_EECCAOS_NHB)
