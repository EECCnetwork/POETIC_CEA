...
source("Markov_Model/probabilistic_analysis/Results/one_way/int_costs/pars_eecccritcosts_nocriticalcare.R")
...
plot_eecccriticalcosts_nothing <-ggplot(no_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
