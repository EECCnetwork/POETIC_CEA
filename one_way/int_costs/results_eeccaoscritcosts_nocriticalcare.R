...
source("Markov_Model/probabilistic_analysis/Results/one_way/int_costs/pars_eeccaoscritcosts_nocriticalcare.R")
...
plot_eeccaoscriticalcosts_nothing <-ggplot(no_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
