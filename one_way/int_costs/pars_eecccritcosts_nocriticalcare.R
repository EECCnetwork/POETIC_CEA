...
eecc_critical_costs <- c(rep(0,nyear),rep(10,nyear),rep(20,nyear),rep(30,nyear),
                          rep(40,nyear),rep(50,nyear),rep(60,nyear),rep(70,nyear),
                          rep(80,nyear), rep(90,nyear),
                          rep(100,nyear), rep(110,nyear))
