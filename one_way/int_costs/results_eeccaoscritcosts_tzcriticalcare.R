...
source("Markov_Model/probabilistic_analysis/Results/one_way/int_costs/pars_eeccaoscritcosts_tzcriticalcare.R")
...
plot_eeccaoscriticalcosts_tanzania <-ggplot(tz_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
