...
source("Markov_Model/probabilistic_analysis/Results/one_way/int_costs/pars_eeccaossevcosts_tzcriticalcare.R")
...
plot_eeccaosseverecosts_tanzania <-ggplot(tz_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
  ...
  scale_x_continuous(limits = c(0, 70), breaks = c(seq(0, 70, by = 5))) +
  theme_bw() +
