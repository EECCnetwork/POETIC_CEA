...
source("Markov_Model/probabilistic_analysis/Results/one_way/int_costs/pars_eeccsevcosts_iscriticalcare.R")
...
plot_eeccseverecosts_isaric <-ggplot(is_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
  ...
  xlab("Unit Cost of Treating Severe Patient\nwith EECC in a Regionalor Referral Hospital ($)") +
