...
source("Markov_Model/probabilistic_analysis/Results/one_way/int_costs/pars_eecccritcosts_iscriticalcare.R")
...
plot_eecccriticalcosts_isaric <-ggplot(is_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
