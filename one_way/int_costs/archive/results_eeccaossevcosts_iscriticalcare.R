...
source("Markov_Model/probabilistic_analysis/Results/one_way/int_costs/pars_eeccaossevcosts_iscriticalcare.R")
...
isaric_oneway <- one_way_sense(outcome_dat = isaric_DALY_dat, 
                                 ...
                                 parameter = eeccaos_severe_costs)
...
plot_eeccaosseverecosts_isaric <-ggplot(is_oneway_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
