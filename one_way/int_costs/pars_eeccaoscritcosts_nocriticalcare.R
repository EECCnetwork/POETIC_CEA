...
eeccaos_critical_costs <- c(rep(50,nyear),rep(100,nyear),rep(150,nyear),rep(200,nyear),
                                 rep(250,nyear),rep(300,nyear),rep(350,nyear),rep(400,nyear),
                                 rep(450,nyear),rep(500,nyear),rep(550,nyear),
                         rep(600,nyear),rep(650,nyear),rep(700,nyear),rep(750,nyear),
                         rep(800,nyear),rep(850,nyear))
