...
eeccaos_severe_costs <- c(rep(10,nyear),rep(15,nyear),rep(20,nyear),rep(25,nyear),rep(30,nyear),
                                 rep(35,nyear),rep(40,nyear),rep(45,nyear),rep(50,nyear),
                                 rep(55,nyear),rep(60,nyear),rep(65,nyear))
