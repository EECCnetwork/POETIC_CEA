...
source("Markov_Model/probabilistic_analysis/Results/one_way/eecc_effectiveness/results_crittosev_eecceff_nocriticalcare.R")

#load data for tz critical care

source("Markov_Model/probabilistic_analysis/Results/one_way/eecc_effectiveness/results_crittosev_eecceff_tzcriticalcare.R")


#load data for tz critical care

#source("Markov_Model/probabilistic_analysis/Results/one_way/eecc_effectiveness/results_crittosev_eecceff_iscriticalcare.R")

#rbind all three dataframes

final_dat <- rbind(no_oneway_dat, tz_oneway_dat)

triage_plot_crittosev_eecceff <-ggplot(final_dat, aes(x = Pars,y = NHB_MEAN, colour=Int)) +
  ...
  xlab("Effectiveness of EECC in increasing probability of critical to severe (%)") +
