...
source("Markov_Model/probabilistic_analysis/Results/one_way/eecc_effectiveness/pars_sevtocrit_iscriticalcare_ecc_eff.R")
...
isaric_oneway <- one_way_sense(outcome_dat = isaric_DALY_dat, 
                                 ...
                                 parameter = eff_eecc_severe_to_critical)
