...
source("Markov_Model/probabilistic_analysis/Results/one_way/critical_probabilities/pars_crittodeath_nocriticalcare.R")
...
nothing_oneway <- one_way_sense(outcome_dat = nothing_DALY_dat, 
                                 ...
                                 parameter = nothing_critical_to_death)
