...
tanzania_critical_to_severe <- c(rep(0.05,nyear),rep(0.06,nyear),
                                 rep(0.07,nyear),rep(0.08,nyear),
                                 rep(0.09,nyear),rep(0.10,nyear))


sens_n <- length(tanzania_critical_to_severe)
