...
source("Markov_Model/probabilistic_analysis/Results/one_way/critical_probabilities/pars_crittodeath_tzcriticalcare.R")
...
tanzania_oneway <- one_way_sense(outcome_dat = tanzania_DALY_dat, 
                                 ...
                                 parameter = tanzania_critical_to_death)
