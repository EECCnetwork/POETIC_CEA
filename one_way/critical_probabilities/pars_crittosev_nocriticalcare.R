...
nothing_critical_to_severe <- c(rep(0.00,nyear),rep(0.02,nyear),rep(0.04,nyear),
                                 rep(0.06,nyear),rep(0.08,nyear),rep(0.1,nyear),rep(0.12,nyear),
                                rep(0.14,nyear),rep(0.16,nyear))


sens_n <- length(nothing_critical_to_severe)
