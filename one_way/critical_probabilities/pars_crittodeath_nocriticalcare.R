...
nothing_critical_to_death <- c(rep(0.50,nyear),rep(0.55,nyear),rep(0.60,nyear),
                                 rep(0.65,nyear),rep(0.70,nyear),rep(0.75,nyear),rep(0.80,nyear))


sens_n <- length(nothing_critical_to_death)
