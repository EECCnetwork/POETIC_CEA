...
tanzania_critical_costs <- c(rep(0,nyear),rep(10,nyear),
                             rep(20,nyear),rep(30,nyear),rep(40,nyear),rep(50,nyear),rep(60,nyear))

sens_n <- length(tanzania_critical_costs)
