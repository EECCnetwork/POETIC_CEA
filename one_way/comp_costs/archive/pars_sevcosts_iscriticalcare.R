...
isaric_severe_costs <- c(rep(180,nyear),rep(200,nyear),rep(220,nyear),rep(240,nyear),rep(260,nyear),
                          rep(280,nyear),rep(300,nyear),rep(320,nyear),rep(340,nyear),
                          rep(360,nyear),rep(380,nyear),rep(400,nyear),rep(420,nyear),
                         rep(440,nyear),rep(460,nyear),rep(480,nyear))

sens_n <- length(isaric_severe_costs)
